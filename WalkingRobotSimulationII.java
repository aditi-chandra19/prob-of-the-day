public class WalkingRobotSimulationII {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Position: (" + pos1[0] + ", " + pos1[1] + "), Direction: " + robot.getDir());

        robot.step(2);
        int[] pos2 = robot.getPos();
        System.out.println("Position: (" + pos2[0] + ", " + pos2[1] + "), Direction: " + robot.getDir());

        robot.step(10);
        int[] pos3 = robot.getPos();
        System.out.println("Position: (" + pos3[0] + ", " + pos3[1] + "), Direction: " + robot.getDir());
    }
}